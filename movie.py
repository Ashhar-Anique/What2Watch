...
def load_models():
    ...
    lower_title_list = {}
    title_list = joblib.load(open('Data\\title_list.pkl', 'rb'))
    similarity_score = joblib.load(open('Data\\similarity2.pkl', 'rb'))

    final_df = joblib.load(open('Data\\movie_data', 'rb'))
...
def main():
    ...
    if(select == 'Home'):
        ...
        img2 = Image.open('Data\\top_15_profit.png')
        ...
        img = Image.open('Data\\shawshank.jpg')
        st.image(img)
        ...
        img2 = Image.open('Data\\top_15_wr.png')
        ...
        img = Image.open('Data\\woody allen.jpg')
        st.image(img)
        img2 = Image.open('Data\\directors.jpg')
        ...
        img = Image.open("Data\\actor.jpg")
        img2 = Image.open("Data\\actors.jpg")
        st.image(img)
        ...
        img = Image.open('Data\\wordcloud.png')
        st.image(img)
        st.subheader("Count Pie chart")
        img2 = Image.open("Data\\wordcount.jpg")
        st.image(img2)
        ...
        img = Image.open('Data\\odessy.jpg')
        st.image(img)
        st.subheader("Other Longest Movies are ")
        show(runtime_id, runtime_list)
        img2 = Image.open('Data\\top_15_runtime.png')
